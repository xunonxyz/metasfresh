...
public class JsonExternalSystemAmazonConfigMapping
{
	...
	@Nullable
	String amazonCustomerGroup;

	@Nullable
	String amazonPaymentMethod;
	...
	public JsonExternalSystemAmazonConfigMapping(
			...
			@JsonProperty("amazonCustomerGroup") @Nullable final String amazonCustomerGroup,
			@JsonProperty("amazonPaymentMethod") @Nullable final String amazonPaymentMethod,
			@JsonProperty("description") @Nullable final String description)
	{
		...
		this.amazonCustomerGroup = amazonCustomerGroup;
		this.amazonPaymentMethod = amazonPaymentMethod;
		this.description = description;
	}

	public boolean isGroupMatching(@NonNull final String sw6CustomerGroup)
	{
		return Check.isBlank(this.amazonCustomerGroup) || this.amazonCustomerGroup.equals(sw6CustomerGroup);
	}

	public boolean isPaymentMethodMatching(@NonNull final String sw6PaymentMethod)
	{
		return Check.isBlank(this.amazonPaymentMethod) || this.amazonPaymentMethod.equals(amazonPaymentMethod);
	}
