...
public class X_C_DataImport extends org.compiere.model.PO implements I_C_DataImport, org.compiere.model.I_Persistent 
{
	...
	private static final long serialVersionUID = -274127499L;
	...
	/** Standard = Standard */
	public static final String DATAIMPORT_CONFIGTYPE_Standard = "Standard";
	/** Bank Statement Import = Bank Statement Import */
	public static final String DATAIMPORT_CONFIGTYPE_BankStatementImport = "Bank Statement Import";
	@Override
	public void setDataImport_ConfigType (final @Nullable java.lang.String DataImport_ConfigType)
	{
