...
public final class Env
{
	...
	private static final Predicate<Object> CTXNAME_MATCHER_AnyWindow = key -> {
		...
		return Character.isDigit(tag.charAt(0));
	};
	...
	private static void setProperty(final Properties ctx, final String key, @Nullable final String value)
	{
	 ...
	 */
	public static void setContext(final Properties ctx, final String context, @Nullable final String value)
	{
	 ...
	 * @param value context value
	 */
	public static void setContext(final Properties ctx, final String context, @Nullable final Date value)
	{
		if (ctx == null || context == null)
		{
			return;
	 ...
	 */
	public static void setAutoNew(final Properties ctx, final boolean autoNew)
	{
		if (ctx == null)
		{
			return;
	 ...
	 */
	public static boolean isAutoNew(final Properties ctx)
	{
		if (ctx == null)
		{
			throw new IllegalArgumentException("Require Context");
		...
		return s != null && StringUtils.toBoolean(s);
	}    // isAutoNew
	 ...
	 */
	public static boolean isSOTrx(final Properties ctx)
	{
	 ...
	 */
	@Deprecated
	public static boolean isSOTrx(final Properties ctx, final int WindowNo)
	{
		final Boolean soTrx = getSOTrxOrNull(ctx, WindowNo);
		return soTrx != null && soTrx;
	}    // isSOTrx
	 ...
	 */
	public static int getAD_Client_ID(final Properties ctx)
	{
		return Env.getContextAsInt(ctx, CTXNAME_AD_Client_ID);
	}    // getAD_Client_ID

	public static ClientId getClientId(final Properties ctx)
	{
	 ...
	 */
	public static int getAD_Org_ID(final Properties ctx)
	{
	 ...
	 */
	public static int getAD_User_ID(final Properties ctx)
	{
	...
	private static String createPreferenceName(
	 ...
	 */
	public static boolean isBaseLanguage(final Properties ctx, final String tableName)
	{
	...
	{
		return tableName.startsWith("AD")
	...
	@Nullable
	@Deprecated
	public static Language getLoginLanguage(final Properties ctx)
	{
	 ...
	 *
	 * <code>@tag@</code> are ignored otherwise "" is returned
	 *
	 * @param ctx context
	 ...
	 */
	public static String parseContext(final Properties ctx, final int WindowNo, final String value, final boolean onlyWindow, final boolean ignoreUnparsable)
	{
		final Evaluatee evalCtx = Evaluatees.ofCtx(ctx, WindowNo, onlyWindow);
		return parseContext(evalCtx, value, ignoreUnparsable);
	}
	...
	public static String parseContext(final Properties ctx, final int WindowNo, final IStringExpression expression, final boolean onlyWindow)
	{
		final boolean ignoreUnparsable = false;
	...
	@SuppressWarnings("StringOperationCanBeSimplified")
	static final String CTXVALUE_NullString = new String(""); // NOTE: new String to make sure it's a unique instance
	...
	private static String getProperty(final Properties ctx, final String context)
	{
		...
		if (CTXNAME_Date.equals(context))
		{
			...
			final boolean logindateAutoupdate = Services.get(ISysConfigBL.class).getBooleanValue("LOGINDATE_AUTOUPDATE", false, Env.getAD_Client_ID(ctx));
			if (logindateAutoupdate)
			{
	...
	@Nullable
	public static Timestamp getContextAsDate(final Properties ctx, final int WindowNo, final String context, final boolean onlyWindow)
	{
		final String s = getContext(ctx, WindowNo, context, onlyWindow);
	...
	@Nullable
	public static Timestamp getContextAsDate(final Properties ctx, final int WindowNo, final int TabNo, final String context)
	{
		return getContextAsDate(ctx, WindowNo, TabNo, context, false);
	}

	@Nullable
	public static Timestamp getContextAsDate(final Properties ctx, final int WindowNo, final int TabNo, final String context, final boolean onlyTab)
	{
		final String s = getContext(ctx, WindowNo, TabNo, context, onlyTab);
		// JDBC Format YYYY-MM-DD example 2000-09-11 00:00:00.0
		if (isPropertyValueNull(s) || "".equals(s))
	...
	public static void setContextAsDate(final Properties ctx, final int WindowNo, final int TabNo, final String context, final Date value)
	{
		if (ctx == null || context == null)
		{
			return;
	 ...
	 * @return int value
	 */
	private static int toInteger(final String s, final String context)
	{
	...
	private static boolean isPropertyValueNull(@Nullable final String value)
	{
	 ...
	 */
	public static boolean isPropertyValueNull(final String propertyName, @Nullable final String value)
	{
		if (value == null || isPropertyValueNull(value))
		{
			return true;
		}
		...
		// NOTE: empty values are considered not null if they are not numeric.
		// Comparation with #CTXVALUE_NullString is done in isPropertyValueNull
		return isNumericPropertyName(propertyName) && Check.isBlank(value);
	}
	...
	public static <V> V get(
			...
			final Supplier<V> valueInitializer)
	{
	 ...
	 */
	@Nullable
	public static <V> V getAndValidate(
			@NonNull final Properties ctx,
			@NonNull final String propertyName,
			@Nullable final Predicate<V> validator,
			@Nullable final Supplier<V> valueInitializer)
	{
