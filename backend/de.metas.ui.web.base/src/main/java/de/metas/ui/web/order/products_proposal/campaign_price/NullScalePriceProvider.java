...
public class NullScalePriceProvider implements ScalePriceProvider
{

	public static final transient NullScalePriceProvider instance = new NullScalePriceProvider();

	private NullScalePriceProvider()
	{
		super();
	}
