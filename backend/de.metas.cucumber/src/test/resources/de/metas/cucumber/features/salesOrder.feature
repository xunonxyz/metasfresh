...
Feature: sales order
  ...
  Scenario: we can generate a mediated purchase order from a sales order with dropship address
    ...
    And metasfresh contains C_BPartner_Locations:
      | Identifier | C_BPartner_ID.Identifier |
      | vendor_26  | vendor_26_location       |
    And metasfresh contains C_Orders:
      | Identifier | IsSOTrx | C_BPartner_ID.Identifier | DateOrdered | OPT.IsDropShip | OPT.DropShip_BPartner_ID.Identifier | OPT.DropShip_Location_ID.Identifier |
      | o_26       | true    | endcustomer_26           | 2021-04-17  | true           | endcustomer_36                      | bpl_26                              |
    And metasfresh contains C_OrderLines:
      | Identifier | C_Order_ID.Identifier | M_Product_ID.Identifier | QtyEntered | OPT.C_BPartner_ID.Identifier | OPT.C_BPartner_Location_ID.Identifier |
      | ol_26      | o_26                  | p_26                    | 10         | shiptopartner_26             | bpl_26                                |
    ...
    Then the order is created:
      ...
      | o_26                     | false   | endcustomer_36                      | true           | POO         | MED        | DR            |
    And the purchase order with document subtype 'MED' linked to order 'o_26' has lines:
      | QtyOrdered | LineNetAmt | M_Product_ID.Identifier | OPT.C_BPartner_ID.Identifier | OPT.C_BPartner_Location_ID.Identifier |
      | 10         | 100        | p_26                    | vendor_26                    | vendor_26_location                    |
