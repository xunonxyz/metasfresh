Feature: Call order contract
  ...
  Scenario: Happy flow for call order contract and call order summary - sales order
    ...
    And validate created C_Flatrate_Term:
      | C_Flatrate_Term_ID.Identifier | C_Flatrate_Conditions_ID.Identifier | Bill_BPartner_ID.Identifier | M_Product_ID.Identifier | OPT.C_OrderLine_Term_ID.Identifier | OPT.C_Order_Term_ID.Identifier | OPT.C_UOM_ID.X12DE355 | OPT.PlannedQtyPerUnit | OPT.PriceActual |
      | callOrder_contract_1          | callOrderConditions                 | bpartner_1                  | call_order_product      | orderLine_1                        | order_1                        | PCE                   | 1000                  | 2.00            |
  ...
  Scenario: Happy flow for call order contract and call order summary - purchase order
    ...
    And validate created invoice lines
      | C_InvoiceLine_ID.Identifier | C_Invoice_ID.Identifier | M_Product_ID.Identifier | qtyinvoiced | processed |
      | invoiceLine_1_1             | invoice_1               | call_order_product_PO   | 6           | true      |
    ...
    And validate created invoice lines
      | C_InvoiceLine_ID.Identifier | C_Invoice_ID.Identifier | M_Product_ID.Identifier | qtyinvoiced | processed |
      | invoiceLine_3_1             | invoice_3               | call_order_product_PO   | 8           | true      |
