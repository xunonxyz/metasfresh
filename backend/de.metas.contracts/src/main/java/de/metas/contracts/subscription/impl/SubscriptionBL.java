...
public class SubscriptionBL implements ISubscriptionBL
{
	...
	@Override
	public void updatePrices(@NonNull final I_C_OrderLine ol, @NonNull final SOTrx soTrx, final boolean updatePriceEnteredAndDiscountOnlyIfNotAlreadySet) {
		...
		final int numberOfRuns = computeNumberOfRuns(flatrateConditions.getC_Flatrate_Transition(), date);
		...
		final Quantity priceQty = qtyOrderedPerRun.multiply(numberOfRuns);//Annamaria2*4
